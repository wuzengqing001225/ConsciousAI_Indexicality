...
NO_ECHO: When True, echo channel is always SILENCE during training
         (train-time ablation for P3 self-monitoring).
"""
...
NO_ECHO = True    # train-time echo ablation for P3
...
print(f"\nIndependent-Parameter Training (NO_ECHO ablation):")
